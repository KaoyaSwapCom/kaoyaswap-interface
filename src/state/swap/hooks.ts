...
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount, Trade } from '@sashimiswap/sdk'
  ...
  const onCurrencySelection = useCallback(
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId: currency instanceof Token ? currency.address : currency === ETHER ? process.env.REACT_APP_CHAIN_NATIVE_TOKEN_SYMBOL as string : ''
        })
      )
    },
    [dispatch]
