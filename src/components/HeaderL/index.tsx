...
export default function Header() {
  ...
  const menuList = [
    ...
    { link: `/swap?outputCurrency=${contractAddresses.sushi[chainId]}`, title: 'Exchanges' },
    ...
    <>
        ...
        <HeaderWrapper>
          <LogoAndMenuWrapper>
            ...
            <MenuWrapper>
              ...
              <MenuItem onClick={() => handleChangeLink('https://kaoyaswap-1.gitbook.io/kaoyaswapdoc/')}>
                <span>Doc</span>
              </MenuItem>
            </MenuWrapper>
      ...
      <MobileMenu style={{ width: isMobileMenu && '75%' }}>
        <div>
          ...
          <MobileItem onClick={() => handleChangeLink('https://kaoyaswap-1.gitbook.io/kaoyaswapdoc/')}>
            <span>Doc</span>
          </MobileItem>
        </div>
      </MobileMenu>
