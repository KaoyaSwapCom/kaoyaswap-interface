...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@sashimiswap/sdk'
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          ...
                          <StyledInternalLink
                            to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? nativeTokenSymbol : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? nativeTokenSymbol : currencyIdB}`}
                          >
